...
- implement some basic QA stuff to throw errors and/or drop rows with missing data
- Allow using by plot or by unit overstory data in the form of a pBA table
- Give the documentation section another edit
...
setwd('D://Foster/FFS/Fuel_Transect_Analyzer')

# all files must be in csv format, and all filenames should include the '.csv' suffix

fuels_data_source = 'example_fuels.csv'

trees_data_source = 'example_treelist.csv'

full_output_filename = 'example_fuel_loads_full.csv'

results_output_filename = 'example_fuel_loads_results.csv'
...
x1h_transect_length = 1.83

x10h_transect_length = 1.83

x100h_transect_length = 3.05

x1000h_transect_length = 11.34
