...
#' present in the dataset. Generated by calling get_spp_codes(dataset).
#'
#' @param timelag_class A string, ('x1h', 'x10h', or 'x100h') identifying
#' the type of fine woody debris to give a coefficient for.
#'
...
#' present in the dataset. Generated by calling get_spp_codes(dataset).
#'
#' @param type A string, either 'sound' or 'rotten', identifying
