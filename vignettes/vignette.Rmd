---
title: "Rfuels Vignette"
author: "Danny Foster"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Rfuels_vignette}
...
takes three arguments:
  ...
  - *fuels_location*, the filepath to a properly formatted .csv file containing 
  the observed fuels data
  - *treelist_location*, the filepath to a properly formatted .csv file containg 
  the observed tree data
...
Rfuels requires the input fuels data to be formatted as a .csv file with a 
row for each observation (a transect on a specific date). The .csv table must 
...
tree on each sampling date, and at least these columns:
...
We got two a message about the type of results returned, and also a warning 
